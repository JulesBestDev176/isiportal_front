  ...
  return (
    <header className="bg-white border-b border-neutral-200 sticky top-0 z-40">
      <div className="flex items-center justify-between px-4 py-3 lg:px-6">
        ...
        <button
          className="p-2 rounded-md hover:bg-neutral-100 transition-colors mr-2"
                      ...
                      notifications.map((notification) => (
                        <div
                          ...
                          className={`px-4 py-3 hover:bg-neutral-50 cursor-pointer border-l-4 transition-colors ${
                            !notification.lu ? 'border-l-primary-500 bg-primary-50' : 'border-l-transparent'
                          }`}
                        >
                  ...
                  {notifications.some(n => !n.lu) && (
                    <div className="px-4 py-3 bg-neutral-50 border-t border-neutral-200">
                      <button
                        ...
                        className="w-full text-sm text-primary-600 font-medium hover:text-primary-700 transition-colors"
                      >
