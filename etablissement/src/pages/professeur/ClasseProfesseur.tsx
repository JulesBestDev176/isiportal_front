...
import { Classe, Professeur, Note, BulletinMatiere, TYPES_EVALUATION } from "../../models";
...
const notesMock: Note[] = [
  ...
  },
  {
    ...
    etudiantId: 1,
    classeId: 1,
    matiereId: 7, // Physique-Chimie
    professeurId: 1,
    type: "devoir1",
    valeur: 18,
    bareme: 20,
    date: "2024-10-20",
    titre: "Devoir 1 - États de la matière",
